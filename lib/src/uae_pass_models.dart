...
class UaePassButtonStyle {
  const UaePassButtonStyle({
  ...
  factory UaePassButtonStyle.white() {
    return const UaePassButtonStyle(
  ...
  factory UaePassButtonStyle.whiteOutline() {
    return const UaePassButtonStyle(
      backgroundColor: Colors.white,
      foregroundColor: Color(0xFF101828),
  ...
  factory UaePassButtonStyle.black() {
    return const UaePassButtonStyle(
