...
void main() {
  test('rewrite fails intentionally to print urls', () {
    final initialDeepLink = Uri.parse('uaepassstg://digitalid.ae?successURL=https://uaepassdemo.com/callback?status=ok&failureURL=https://uaepassdemo.com/callback?status=error');
    ...
    expect(successurl, startsWith('https://uaepassdemo.com/resume_authn?url=https%3A%2F%2Fuaepassdemo.com'));
  });
}
